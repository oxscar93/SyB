...
@Injectable()
export class CategoriaDialogService {
   ...
   */
  addCategoria(options: IDialogOptions): Promise<any> {
    this.state.options = options;
    this.state.modal = this.modalService.open(this.state.templates["addCategoria"], { centered: true, windowClass: 'modal-custom'});

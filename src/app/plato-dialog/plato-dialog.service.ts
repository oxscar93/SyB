...
@Injectable()
export class PlatoDialogService {
   ...
   */
  addPlato(options: IDialogOptions): Promise<any> {
    this.state.options = options;
    this.state.modal = this.modalService.open(this.state.templates["addPlato"], { centered: true, windowClass: 'modal-custom'});
